...
uint256 hashGenesisBlock("0x89a062eab943c19575950f0279c75de7aebee79484ed652de2405f4861e8c739");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaaf18c5c3a624c077f78047ca3365952a7a61f601755cc0114a1198dbec1097e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("1c2ceb774df18170074841b1889accbcd801d16609e31b97a2293af4fcd433b12a606dcea2f27cd2e23cf1610733f59c3c1c74894709983465d0aaa9ef219b9768") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1528757115;
        block.nBits    = 504365644;
        block.nNonce   = 3758633780;

        if (fTestNet)
        {
            block.nTime    = 1528757115;
            block.nNonce   = 2356095572;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6e9c50adbcba92f816453c010abb11f1621874d3291eb2f2c78aa84b5e3cf5f2"));
        block.print();
